...
영어 문법을 체계적으로 정리한 레퍼런스 가이드입니다.

---

## 📚 문법 목차

### Week 1: 기초 문법 (Basic Grammar)
1. [Be동사 (am, is, are, was, were)](./01-be-verb.md)
2. [일반동사 현재형 (Simple Present)](./02-simple-present.md)
3. [일반동사 과거형 (Simple Past)](./03-simple-past.md)
6. [진행형 (Progressive Tenses)](./06-progressive.md)
8. [조동사 (Modal Verbs)](./08-modals.md)

### Week 2: 중급 문법 (Intermediate Grammar)
4. [현재완료 (Present Perfect)](./04-present-perfect.md)
5. [미래형 (Future Tenses)](./05-future.md)
7. [비교급과 최상급 (Comparatives & Superlatives)](./07-comparatives.md)
...
### 학습 순서
1. 주차별 학습 중 문법이 나오면 해당 페이지 참고
2. 이해가 안 되면 문법 가이드에서 상세 설명 확인
3. 연습 문제로 이해도 체크
...
### Week 1: 기초 시제 (5개 문법)
- 01: Be동사 (am/is/are, was/were)
- 02: 일반동사 현재형 (Simple Present)
- 03: 일반동사 과거형 (Simple Past)
- 06: 진행형 (Present/Past Progressive)
- 08: 조동사 (can, should, will, must)

**학습 결과**: 자기소개, 일과 말하기, 경력 설명, 요청/제안 표현

### Week 2: 중급 시제 & 문장 구성 (5개 문법)
- 04: 현재완료 (Present Perfect - 경험/완료/계속)
- 05: 미래형 (will, be going to, 현재진행형)
- 07: 비교급/최상급 (Comparatives & Superlatives)
- 09: 전치사 (시간/장소/비즈니스 전치사)
- 10: 접속사 (등위/종속접속사)
